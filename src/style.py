...
.lgrid a img{width:34px;height:40px;object-fit:cover;border-radius:0;background:var(--soft);
  flex:0 0 34px}
...
.mega-promo{border-radius:0;overflow:hidden;position:relative;background:var(--soft)}
...
.mega-best a{flex:1}
.mega-best img{width:100%;aspect-ratio:1/1.2;object-fit:cover;border-radius:0}
...
.srch-prods img{width:100%;aspect-ratio:1/1.3;object-fit:cover;border-radius:0;background:var(--soft)}
...
.dgrid img{width:34px;height:42px;object-fit:cover;border-radius:0;background:var(--soft);flex:0 0 34px}
...
.dpromo a{position:relative;flex:0 0 60%;border-radius:0;overflow:hidden;background:var(--soft)}
...
.cat .ci{position:relative;overflow:hidden;border-radius:0;background:var(--soft2);
  aspect-ratio:1/1.05}
...
.card .tag{position:absolute;top:0;left:0;background:var(--brand);color:#fff;font-size:9px;font-weight:700;
  padding:4px 9px;border-radius:0;z-index:2}
...
.atcbtn{flex:1 1 100%;padding:10px 6px;border:1.4px solid var(--ink);border-radius:0;
...
.ci img{width:82px;aspect-ratio:1/1.3;object-fit:cover;border-radius:0;background:var(--soft)}
.ci .bd{flex:1}
...
.card .tags .tag{position:static;border-radius:0}
